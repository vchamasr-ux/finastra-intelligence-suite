...
function App() {
  ...
  return (
    <div className="h-screen overflow-hidden pt-12 flex flex-col bg-finastra-black bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(193,55,162,0.1),rgba(255,255,255,0))] text-slate-300 font-sans selection:bg-finastra-fuchsia/30">
      <GlobalNav />
      {/* Top Navbar */}
      ...
      {/* Main Content */}
      <main className="w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex flex-col flex-1 min-h-0 overflow-hidden">
        <div className="flex flex-col gap-4 sm:gap-6 h-full min-h-0">
          ...
          {/* Intelligence Grid */}
          <div className="flex-1 min-h-0 glass-panel rounded-2xl p-2 sm:p-6 ring-1 ring-white/5 shadow-2xl flex flex-col mt-2">
            {loading ? (
