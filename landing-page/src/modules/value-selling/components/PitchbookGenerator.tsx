    ...
    <div className="w-80 border-r border-gray-800 bg-gray-900/50 backdrop-blur-xl p-6 flex flex-col gap-8 h-screen overflow-y-auto">
      <div>
        ...
        <div className="mb-6">
          ...
          {searchResults.length === 0 && hasSearched && searchQuery && !loading && !error && (
            <div className="mt-3 p-3 bg-gray-800/50 border border-gray-700 rounded-md text-gray-400 text-xs">
