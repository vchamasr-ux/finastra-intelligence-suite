          ...
          <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto w-full">
            ...
            >
              ...
              <div className="flex gap-3 mt-auto pt-4">
                <span className="text-xs font-bold px-3 py-1.5 rounded-md bg-slate-800/80 text-slate-300 border border-slate-700">Port 5174</span>
            ...
            >
              ...
              <div className="flex gap-3 mt-auto pt-4">
                <span className="text-xs font-bold px-3 py-1.5 rounded-md bg-slate-800/80 text-slate-300 border border-slate-700">Port 5173</span>
